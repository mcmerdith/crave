  ...
  return (
    ...
    >
      <View style={styles.modalContent}>
        {/* ✅ Props are correctly on the ScrollView tag */}
        <ScrollView
                ...
                <View style={styles.reviewHeader}>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    {[...Array(review.rating)].map((_, i) => (
                      <Ionicons key={i} name="star" size={14} color="#F6BE00" style={{ marginLeft: 2 }} />
                    ))}
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  modalContent: {
    ...
    // ✅ overflow: "hidden" removed — was clipping ScrollView on iOS
  },
  content: {
    padding: 16,
    paddingBottom: 40,
